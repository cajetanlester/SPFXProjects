...
import { ISpfxPnpJsExampleProps } from './ISpfxPnpJsExampleProps';
...
export default class PnPjsExample extends React.Component<ISpfxPnpJsExampleProps, IIPnPjsExampleState> {
  private LOG_SOURCE = "M365Updates";
  private LIBRARY_NAME = "Documents";
  private _sp: SPFI;

  constructor(props: ISpfxPnpJsExampleProps) {
    super(props);
    // set initial state
    this.state = {
      items: [],
  ...
  public render(): React.ReactElement<IAsyncAwaitPnPJsProps> {
    ...
    const totalDocs: number = this.state.items.length > 0
      ...
      : 0;
    return (
      <div className={styles.spfxPnpJsExample}>
